...
INDIA_STARTUP_JOBS = [
    {
        ...
        "apply_url": "https://careers.swiggy.com/jobs/backend-engineer",
    ...
    },
    {
        ...
        "apply_url": "https://razorpay.com/jobs/fullstack-lead",
    ...
    },
    {
        ...
        "apply_url": "https://zerodha.tech/careers/interns",
        "apply_email": "jobs@zerodha.tech",
        "posted_date": "2026-08-03",
        "source": "Internshala",
    ...
    },
    {
        ...
        "apply_url": "https://zepto.com/careers/ai-intern",
    ...
    },
    {
        ...
        "apply_url": "https://postman.com/careers/frontend-engineer-in",
    ...
    },
    {
        ...
        "apply_url": "https://cred.club/careers/data-engineer",
    ...
    },
    {
        ...
        "apply_url": "https://pw.live/careers/interns",
    ...
    },
    {
        ...
        "apply_url": "https://groww.in/careers/devops-lead",
    ...
    },
    {
        ...
        "apply_url": "https://phonepe.com/careers/qa-engineer",
...
def discover_all_jobs(strict_compliance_mode: bool = False) -> List[Dict[str, Any]]:
    ...
    # 2. Enhanced Canonical Deduplication
    # Combines normalized company, canonical role family, and location
    seen_keys = set()
    seen_ids = set()
    unique_jobs = []
    ...
    for job in raw_discovered:
        ...
        # Composite deduplication fingerprint
        dedup_key = f"{company_norm}::{canonical_role}::{loc_norm}"
