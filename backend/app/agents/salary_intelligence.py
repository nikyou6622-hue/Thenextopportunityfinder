...
def lookup_salary_benchmark(company: str, role_title: str = "Software Engineer", location: str = "India") -> Dict[str, Any]:
    ...
    if is_intern:
        ...
        return {
            ...
            "is_internship": True,
            "monthly_stipend_inr_range": f"INR {stipend_min:,} - INR {stipend_max:,} / month",
    ...
    return {
        ...
        "tier_rating": tier_info["rating"],
        "is_internship": False,
        "annual_ctc_inr_range": f"INR {min_sal / 100000:.1f}L - INR {max_sal / 100000:.1f}L",
        "median_ctc_inr": f"INR {med_sal / 100000:.1f} Lakhs",
        "min_inr_raw": min_sal,
        "max_inr_raw": max_sal,
