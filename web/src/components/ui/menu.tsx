            ...
            <React.Fragment key={index}>
              ...
              <motion.a
                ...
                className={cn(
                  ...
                  item.isActive 
                    ? "bg-[#1c2237] text-white font-semibold shadow-sm" 
                    : "text-muted-foreground hover:bg-accent hover:text-accent-foreground"
                )}
              >
                <span className="mr-3 h-5 w-5 flex items-center justify-center">{item.icon}</span>
        ...
        {logoutItem && (
          <motion.div variants={itemVariants} className="mt-4">
            <button
              ...
              className="group flex w-full items-center rounded-md px-3 py-2.5 text-sm font-medium text-destructive transition-colors hover:bg-destructive/10 cursor-pointer"
            >
              <span className="mr-3 h-5 w-5 flex items-center justify-center">{logoutItem.icon}</span>
